...
mixin _$GroupMember {
 ...
 String get id; String get displayName; String get inviteCode; String? get linkedUserId;@TimestampConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,displayName,inviteCode,linkedUserId,createdAt);

@override
String toString() {
  return 'GroupMember(id: $id, displayName: $displayName, inviteCode: $inviteCode, linkedUserId: $linkedUserId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String displayName, String inviteCode, String? linkedUserId,@TimestampConverter() DateTime createdAt
});
...
/// Create a copy of GroupMember
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? displayName = null,Object? inviteCode = null,Object? linkedUserId = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String displayName,  String inviteCode,  String? linkedUserId, @TimestampConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupMember() when $default != null:
return $default(_that.id,_that.displayName,_that.inviteCode,_that.linkedUserId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String displayName,  String inviteCode,  String? linkedUserId, @TimestampConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _GroupMember():
return $default(_that.id,_that.displayName,_that.inviteCode,_that.linkedUserId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String displayName,  String inviteCode,  String? linkedUserId, @TimestampConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _GroupMember() when $default != null:
return $default(_that.id,_that.displayName,_that.inviteCode,_that.linkedUserId,_that.createdAt);case _:
  return null;
...
class _GroupMember implements GroupMember {
  const _GroupMember({required this.id, required this.displayName, required this.inviteCode, this.linkedUserId, @TimestampConverter() required this.createdAt});
...
/// Create a copy of GroupMember
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? displayName = null,Object? inviteCode = null,Object? linkedUserId = freezed,Object? createdAt = null,}) {
